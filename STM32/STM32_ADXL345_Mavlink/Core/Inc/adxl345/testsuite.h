/** @file
 *    @brief MAVLink comm protocol testsuite generated from adxl345.xml
 *    @see https://mavlink.io/en/
 */
#pragma once
#ifndef ADXL345_TESTSUITE_H
#define ADXL345_TESTSUITE_H
...
static void mavlink_test_adxl345(uint8_t, uint8_t, mavlink_message_t *last_msg);

static void mavlink_test_all(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
    mavlink_test_standard(system_id, component_id, last_msg);
    mavlink_test_adxl345(system_id, component_id, last_msg);
}
#endif
...
static void mavlink_test_adxl345(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
