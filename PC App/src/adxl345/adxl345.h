/** @file
 *  @brief MAVLink comm protocol generated from adxl345.xml
 *  @see http://mavlink.org
 */
#pragma once
#ifndef MAVLINK_ADXL345_H
#define MAVLINK_ADXL345_H

#ifndef MAVLINK_H
    #error Wrong include order: MAVLINK_ADXL345.H MUST NOT BE DIRECTLY USED. Include mavlink.h from the same directory instead or set ALL AND EVERY defines from MAVLINK.H manually accordingly, including the #define MAVLINK_H call.
#endif

#define MAVLINK_ADXL345_XML_HASH 8772162768515442423
